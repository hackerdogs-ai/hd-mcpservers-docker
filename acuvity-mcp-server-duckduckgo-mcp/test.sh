...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-duckduckgo-mcp:latest"
PORT=8414
CONTAINER_NAME="acuvity-mcp-server-duckduckgo-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_duckduckgo_info","arguments":{}}}'

echo "========== acuvity-mcp-server-duckduckgo-mcp test (compliance) =========="
