#!/bin/bash
# Test script for Cloudlist MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/cloudlist-mcp:latest"
PORT=8111
BINARY="cloudlist"
CONTAINER_NAME="cloudlist-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Cloudlist MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
# Test 6: Skipped — cloudlist requires cloud provider credentials
info "[Test 6] MCP HTTP — tools/call (SKIPPED)"
echo -e "  ${YELLOW}⚠️  Skipped: cloudlist requires cloud provider credentials to run tools/call${NC}"
echo ""
