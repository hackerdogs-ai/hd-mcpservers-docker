...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"detect_language","arguments":{"text":"This is a test sentence in English."}}}'

echo "========== webc-mcp test (compliance) =========="
