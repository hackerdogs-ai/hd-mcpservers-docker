...
PASS=0; FAIL=0
IMAGE="hackerdogs/mapboxserver-mcp:latest"
PORT=8429
CONTAINER_NAME="mapboxserver-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"mapboxserver_info","arguments":{}}}'

echo "========== mapboxserver-mcp test (compliance) =========="
