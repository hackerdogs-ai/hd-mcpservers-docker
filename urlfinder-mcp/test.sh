#!/bin/bash
# Test script for URLFinder MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/urlfinder-mcp:latest"
PORT=8112
BINARY="urlfinder"
CONTAINER_NAME="urlfinder-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}URLFinder MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
