...
PASS=0; FAIL=0
IMAGE="hackerdogs/pdf-reader-mcp:latest"
PORT=8442
CONTAINER_NAME="pdf-reader-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"pdf_reader_info","arguments":{}}}'

echo "========== pdf-reader-mcp test (compliance) =========="
