...
PASS=0; FAIL=0
IMAGE="hackerdogs/n2yo-mcp:latest"
PORT=8435
CONTAINER_NAME="n2yo-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"n2yo_info","arguments":{}}}'

echo "========== n2yo-mcp test (compliance) =========="
...
"$MCP_PYTHON" "$PROJECT_DIR/../scripts/mcp_stdio_docker_tools_list.py" --check "$IMAGE" 2>/dev/null && pass "stdio tools/list" || fail "stdio tools/list"
