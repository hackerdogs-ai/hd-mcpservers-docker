#!/bin/bash
# Build and Publish File Operations MCP Server Docker Image to Docker Hub
...
# Configuration
IMAGE_NAME="file-operations-mcp"
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish File Operations MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing File Operations MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building File Operations MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing File Operations MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
