#!/bin/bash
# Build and Publish NetExec MCP Server Docker Image to Docker Hub
# Image name: netexec-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish NetExec MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing NetExec MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building NetExec MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing NetExec MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
