#!/bin/bash
# Build and Publish QSReplace MCP Server Docker Image to Docker Hub
# Image name: qsreplace-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish QSReplace MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing QSReplace MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building QSReplace MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing QSReplace MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
