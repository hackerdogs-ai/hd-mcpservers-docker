#!/bin/bash
# Build and Publish A2A Scanner MCP Server Docker Image to Docker Hub
# Image name: a2a-scanner-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish A2A Scanner MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing A2A Scanner MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building A2A Scanner MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing A2A Scanner MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
