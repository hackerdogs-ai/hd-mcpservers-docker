#!/bin/bash
# Build and Publish CrackMapExec MCP Server Docker Image to Docker Hub
# Image name: crackmapexec-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish CrackMapExec MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing CrackMapExec MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building CrackMapExec MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing CrackMapExec MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
