...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-alterx-mcp:latest"
PORT=8380
CONTAINER_NAME="acuvity-mcp-server-alterx-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_alterx_info","arguments":{}}}'

echo "========== acuvity-mcp-server-alterx-mcp test (compliance) =========="
