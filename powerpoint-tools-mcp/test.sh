...
PASS=0; FAIL=0
IMAGE="powerpoint-tools-mcp"
PORT=8507
CONTAINER_NAME="powerpoint-tools-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"read_presentation","arguments":{"file_path":"/tmp/nonexistent.pptx"}}}'

echo "========== powerpoint-tools-mcp test (compliance) =========="
