...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-harness-mcp:latest"
PORT=8426
CONTAINER_NAME="acuvity-mcp-server-harness-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_harness_info","arguments":{}}}'

echo "========== acuvity-mcp-server-harness-mcp test (compliance) =========="
