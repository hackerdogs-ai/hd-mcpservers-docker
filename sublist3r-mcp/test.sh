#!/bin/bash
# Test script for Sublist3r MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/sublist3r-mcp:latest"
PORT=8301
BINARY="sublist3r"
CONTAINER_NAME="sublist3r-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Sublist3r MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (run_sublist3r)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_sublist3r","arguments":{"arguments":"--help"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_sublist3r returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_sublist3r returned content"
else
    fail "tools/call run_sublist3r did not return expected response"
