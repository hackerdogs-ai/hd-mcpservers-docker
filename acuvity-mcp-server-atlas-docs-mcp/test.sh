...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-atlas-docs-mcp:latest"
PORT=8403
CONTAINER_NAME="acuvity-mcp-server-atlas-docs-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_atlas_docs_info","arguments":{}}}'

echo "========== acuvity-mcp-server-atlas-docs-mcp test (compliance) =========="
