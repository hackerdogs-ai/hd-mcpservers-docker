...
PASS=0; FAIL=0
IMAGE="phoneinfoga-mcp"
PORT=8503
CONTAINER_NAME="phoneinfoga-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_phoneinfoga","arguments":{"arguments":"version"}}}'

echo "========== phoneinfoga-mcp test (compliance) =========="
