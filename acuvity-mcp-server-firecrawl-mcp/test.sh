...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-firecrawl-mcp:latest"
PORT=8421
CONTAINER_NAME="acuvity-mcp-server-firecrawl-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_firecrawl_info","arguments":{}}}'

echo "========== acuvity-mcp-server-firecrawl-mcp test (compliance) =========="
