#!/bin/bash
# Build and Publish Uncover MCP Docker Image to Docker Hub
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Uncover MCP Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Uncover MCP Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Uncover MCP Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Uncover MCP Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
