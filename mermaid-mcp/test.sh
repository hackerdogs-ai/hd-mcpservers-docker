...
IMAGE="mermaid-mcp"
PORT=8524
CONTAINER_NAME="mermaid-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"render_mermaid","arguments":{"content":"graph TD; A-->B"}}}'
echo "========== mermaid-mcp test (compliance) =========="
info "[1] Install"
