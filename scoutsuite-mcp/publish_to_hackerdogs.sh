#!/bin/bash
# Build and Publish Scout Suite MCP Server Docker Image to Docker Hub
# Image name: scoutsuite-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Scout Suite MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Scout Suite MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Scout Suite MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Scout Suite MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
