...
PASS=0; FAIL=0
IMAGE="hackerdogs/financial-datasets-mcp:latest"
PORT=8420
CONTAINER_NAME="financial-datasets-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"financial_datasets_info","arguments":{}}}'

echo "========== financial-datasets-mcp test (compliance) =========="
