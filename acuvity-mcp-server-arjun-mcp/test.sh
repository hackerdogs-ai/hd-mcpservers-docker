...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-arjun-mcp:latest"
PORT=8382
CONTAINER_NAME="acuvity-mcp-server-arjun-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_arjun_info","arguments":{}}}'

echo "========== acuvity-mcp-server-arjun-mcp test (compliance) =========="
