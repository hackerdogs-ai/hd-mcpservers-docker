#!/bin/bash
# Build and Publish Subjack MCP Server Docker Image to Docker Hub
# Image name: subjack-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Subjack MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Subjack MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Subjack MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Subjack MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
