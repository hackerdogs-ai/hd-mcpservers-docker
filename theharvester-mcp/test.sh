#!/bin/bash
# Test script for theHarvester MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/theharvester-mcp:latest"
PORT=8204
BINARY="theHarvester"
CONTAINER_NAME="theharvester-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}theHarvester MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (run_theharvester)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_theharvester","arguments":{"arguments":"--help"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_theharvester returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_theharvester returned content"
else
    fail "tools/call run_theharvester did not return expected response"
