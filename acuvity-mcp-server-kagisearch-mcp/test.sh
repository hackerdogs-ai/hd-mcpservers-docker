...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-kagisearch-mcp:latest"
PORT=8428
CONTAINER_NAME="acuvity-mcp-server-kagisearch-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_kagisearch_info","arguments":{}}}'

echo "========== acuvity-mcp-server-kagisearch-mcp test (compliance) =========="
