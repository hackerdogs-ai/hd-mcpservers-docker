...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-microsoft-graph-mcp:latest"
PORT=8433
CONTAINER_NAME="acuvity-mcp-server-microsoft-graph-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_microsoft_graph_info","arguments":{}}}'

echo "========== acuvity-mcp-server-microsoft-graph-mcp test (compliance) =========="
