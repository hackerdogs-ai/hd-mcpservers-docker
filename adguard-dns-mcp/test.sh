...
PASS=0; FAIL=0
IMAGE="adguard-dns-mcp"
PORT=8509
CONTAINER_NAME="adguard-dns-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"adguard_dns_check","arguments":{"host":"example.com"}}}'
echo "========== adguard-dns-mcp test (compliance) =========="
info "[1] Install"
