...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-assetfinder-mcp:latest"
PORT=8383
CONTAINER_NAME="acuvity-mcp-server-assetfinder-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_assetfinder_info","arguments":{}}}'

echo "========== acuvity-mcp-server-assetfinder-mcp test (compliance) =========="
