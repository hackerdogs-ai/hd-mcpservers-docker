...
PASS=0; FAIL=0
IMAGE="apple-itunes-mcp"
PORT=8511
CONTAINER_NAME="apple-itunes-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"itunes_search_apps","arguments":{"domain":"google.com"}}}'
echo "========== apple-itunes-mcp test (compliance) =========="
info "[1] Install"
