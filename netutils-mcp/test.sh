...
PASS=0; FAIL=0
IMAGE="hackerdogs/netutils-mcp:latest"
PORT=8436
CONTAINER_NAME="netutils-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"netutils_info","arguments":{}}}'

echo "========== netutils-mcp test (compliance) =========="
