...
PASS=0; FAIL=0
IMAGE="hackerdogs/ctgov-mcp-docker-mcp:latest"
PORT=8401
CONTAINER_NAME="ctgov-mcp-docker-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"ctgov_mcp_docker_info","arguments":{}}}'

echo "========== ctgov-mcp-docker-mcp test (compliance) =========="
