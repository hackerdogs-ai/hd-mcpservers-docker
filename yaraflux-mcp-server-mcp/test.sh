...
PASS=0; FAIL=0
IMAGE="hackerdogs/yaraflux-mcp-server-mcp:latest"
PORT=8461
CONTAINER_NAME="yaraflux-mcp-server-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"yaraflux_mcp_server_info","arguments":{}}}'

echo "========== yaraflux-mcp-server-mcp test (compliance) =========="
