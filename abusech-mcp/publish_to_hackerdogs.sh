#!/bin/bash
# Build and Publish Abuse.ch MCP Server Docker Image to Docker Hub
# Image name: abusech-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Abuse.ch MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Abuse.ch MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Abuse.ch MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Abuse.ch MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
