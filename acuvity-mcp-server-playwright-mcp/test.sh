...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-playwright-mcp:latest"
PORT=8444
CONTAINER_NAME="acuvity-mcp-server-playwright-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_playwright_info","arguments":{}}}'

echo "========== acuvity-mcp-server-playwright-mcp test (compliance) =========="
