...
PASS=0; FAIL=0
IMAGE="hackerdogs/edu-data-mcp:latest"
PORT=8416
CONTAINER_NAME="edu-data-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"edu_data_info","arguments":{}}}'

echo "========== edu-data-mcp test (compliance) =========="
