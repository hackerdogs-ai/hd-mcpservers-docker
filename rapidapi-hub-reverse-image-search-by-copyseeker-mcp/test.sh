...
PASS=0; FAIL=0
IMAGE="rapidapi-hub-reverse-image-search-by-copyseeker-mcp"
PORT=8660
CONTAINER_NAME="rapidapi-hub-reverse-image-search-by-copyseeker-mcp-test"
...
echo "========== rapidapi-hub-reverse-image-search-by-copyseeker-mcp test (compliance) =========="
info "[1] Install"
