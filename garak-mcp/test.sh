#!/bin/bash
# Test script for Garak MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/garak-mcp:latest"
PORT=8352
BINARY="garak-mcp"
...
echo "================================================================================="
echo -e "${BLUE}Garak MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_garak_mcp returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_garak_mcp returned content"
else
    fail "tools/call run_garak_mcp did not return expected response"
