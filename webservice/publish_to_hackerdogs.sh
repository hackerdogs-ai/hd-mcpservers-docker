#!/bin/bash
# Build and Publish Tools Web Service Docker Image to Docker Hub
# Image name: tools-webservice
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Tools Web Service Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Tools Web Service Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Tools Web Service Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Tools Web Service Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
