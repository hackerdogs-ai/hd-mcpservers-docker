#!/bin/bash
# Test script for OpenRisk MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/openrisk-mcp:latest"
PORT=8115
BINARY="openrisk"
CONTAINER_NAME="openrisk-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}OpenRisk MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
BINARY_OUTPUT=$(docker run --rm "$IMAGE" $BINARY -h 2>&1 | head -5 || true)
...
# Test 6: Skipped — openrisk requires OPENAI_API_KEY
info "[Test 6] MCP HTTP — tools/call (SKIPPED)"
echo -e "  ${YELLOW}⚠️  Skipped: openrisk requires OPENAI_API_KEY to run tools/call${NC}"
echo ""
