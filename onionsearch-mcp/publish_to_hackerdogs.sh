#!/bin/bash
# Build and Publish OnionSearch MCP Server Docker Image to Docker Hub
# Image name: onionsearch-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish OnionSearch MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing OnionSearch MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building OnionSearch MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing OnionSearch MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
