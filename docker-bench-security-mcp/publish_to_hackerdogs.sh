#!/bin/bash
# Build and Publish Docker Bench Security MCP Server Docker Image to Docker Hub
# Image name: docker-bench-security-mcp
...
# Configuration
IMAGE_NAME="docker-bench-security-mcp"
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Docker Bench Security MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Docker Bench Security MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Docker Bench Security MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Docker Bench Security MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
