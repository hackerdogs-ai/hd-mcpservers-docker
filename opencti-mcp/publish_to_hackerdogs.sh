#!/bin/bash
# Build and Publish OpenCTI MCP Server Docker Image to Docker Hub
# Image name: opencti-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish OpenCTI MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing OpenCTI MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building OpenCTI MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing OpenCTI MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
