#!/bin/bash
# Build and Publish Jaeles MCP Server Docker Image to Docker Hub
# Image name: jaeles-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Jaeles MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Jaeles MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Jaeles MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Jaeles MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
