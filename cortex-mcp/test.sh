...
PASS=0; FAIL=0
IMAGE="hackerdogs/cortex-mcp:latest"
PORT=8410
CONTAINER_NAME="cortex-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"cortex_info","arguments":{}}}'

echo "========== cortex-mcp test (compliance) =========="
