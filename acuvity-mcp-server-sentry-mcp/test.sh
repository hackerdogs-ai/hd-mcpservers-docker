...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-sentry-mcp:latest"
PORT=8452
CONTAINER_NAME="acuvity-mcp-server-sentry-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_sentry_info","arguments":{}}}'

echo "========== acuvity-mcp-server-sentry-mcp test (compliance) =========="
