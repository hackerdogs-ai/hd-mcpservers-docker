...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-atlassian-mcp:latest"
PORT=8404
CONTAINER_NAME="acuvity-mcp-server-atlassian-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_atlassian_info","arguments":{}}}'

echo "========== acuvity-mcp-server-atlassian-mcp test (compliance) =========="
