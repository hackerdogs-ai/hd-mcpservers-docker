...
IMAGE="scrapy-mcp"
PORT=8526
CONTAINER_NAME="scrapy-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"scrapy_crawl","arguments":{"url":"https://example.com"}}}'
echo "========== scrapy-mcp test (compliance) =========="
info "[1] Install"
