#!/bin/bash
# Test script for Nerva MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/nerva-mcp:latest"
PORT=8104
BINARY="nerva"
CONTAINER_NAME="nerva-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Nerva MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (list_capabilities)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"list_capabilities","arguments":{}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call list_capabilities returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call list_capabilities returned content"
else
    fail "tools/call list_capabilities did not return expected response"
