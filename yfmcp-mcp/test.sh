...
PASS=0; FAIL=0
IMAGE="hackerdogs/yfmcp-mcp:latest"
PORT=8460
CONTAINER_NAME="yfmcp-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"yfmcp_info","arguments":{}}}'

echo "========== yfmcp-mcp test (compliance) =========="
