...
PASS=0; FAIL=0
IMAGE="hackerdogs/opencv-mcp-server-mcp:latest"
PORT=8440
CONTAINER_NAME="opencv-mcp-server-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"opencv_mcp_server_info","arguments":{}}}'

echo "========== opencv-mcp-server-mcp test (compliance) =========="
