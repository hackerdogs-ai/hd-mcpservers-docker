...
PASS=0; FAIL=0
IMAGE="hackerdogs/earthquake-mcp:latest"
PORT=8457
CONTAINER_NAME="earthquake-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"earthquake_info","arguments":{}}}'

echo "========== earthquake-mcp test (compliance) =========="
