...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-google-maps-mcp:latest"
PORT=8424
CONTAINER_NAME="acuvity-mcp-server-google-maps-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_google_maps_info","arguments":{}}}'

echo "========== acuvity-mcp-server-google-maps-mcp test (compliance) =========="
