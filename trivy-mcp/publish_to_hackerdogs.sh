#!/bin/bash
# Build and Publish Trivy MCP Server Docker Image to Docker Hub
# Image name: trivy-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Trivy MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Trivy MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Trivy MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Trivy MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
