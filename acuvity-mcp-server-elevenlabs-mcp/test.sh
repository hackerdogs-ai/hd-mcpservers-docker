...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-elevenlabs-mcp:latest"
PORT=8417
CONTAINER_NAME="acuvity-mcp-server-elevenlabs-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_elevenlabs_info","arguments":{}}}'

echo "========== acuvity-mcp-server-elevenlabs-mcp test (compliance) =========="
