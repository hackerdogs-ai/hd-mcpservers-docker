...
PASS=0; FAIL=0
IMAGE="hackerdogs/aistor-mcp:latest"
PORT=8434
CONTAINER_NAME="aistor-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"aistor_info","arguments":{}}}'

echo "========== aistor-mcp test (compliance) =========="
