...
PASS=0
FAIL=0
IMAGE="hackerdogs/volatility3-mcp:latest"
PORT=8247
BINARY="volatility"
CONTAINER_NAME="volatility3-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Volatility3 MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (run_volatility3)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_volatility3","arguments":{"arguments":"--help"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_volatility3 returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_volatility3 returned content"
else
    fail "tools/call run_volatility3 did not return expected response"
