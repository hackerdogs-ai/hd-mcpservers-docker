#!/bin/bash
# Build and Publish Volatility3 MCP Server Docker Image to Docker Hub
# Image name: volatility3-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Volatility3 MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Volatility3 MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Volatility3 MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Volatility3 MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
