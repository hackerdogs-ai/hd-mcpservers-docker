#!/bin/bash
# Build and Publish ZAP Lis MCP Server Docker Image to Docker Hub
# Image name: zap-lis-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish ZAP Lis MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing ZAP Lis MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building ZAP Lis MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing ZAP Lis MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
