...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-notion-mcp:latest"
PORT=8437
CONTAINER_NAME="acuvity-mcp-server-notion-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_notion_info","arguments":{}}}'

echo "========== acuvity-mcp-server-notion-mcp test (compliance) =========="
