#!/bin/bash
# Build and Publish Libc-Database MCP Server Docker Image to Docker Hub
# Image name: libc-database-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Libc-Database MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Libc-Database MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Libc-Database MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Libc-Database MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
