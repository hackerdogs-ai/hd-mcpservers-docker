...
PASS=0; FAIL=0
IMAGE="hackerdogs/youtube-mcp:latest"
PORT=8462
CONTAINER_NAME="youtube-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"youtube_info","arguments":{}}}'

echo "========== youtube-mcp test (compliance) =========="
