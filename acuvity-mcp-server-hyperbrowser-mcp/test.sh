...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-hyperbrowser-mcp:latest"
PORT=8427
CONTAINER_NAME="acuvity-mcp-server-hyperbrowser-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_hyperbrowser_info","arguments":{}}}'

echo "========== acuvity-mcp-server-hyperbrowser-mcp test (compliance) =========="
