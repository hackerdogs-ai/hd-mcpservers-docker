#!/bin/bash
# Test script for Aircrack-ng MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/aircrack-ng-mcp:latest"
PORT=8321
BINARY="aircrack-ng"
CONTAINER_NAME="aircrack-ng-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Aircrack-ng MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (run_aircrack_ng)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_aircrack_ng","arguments":{"arguments":"--help"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_aircrack_ng returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_aircrack_ng returned content"
else
    fail "tools/call run_aircrack_ng did not return expected response"
