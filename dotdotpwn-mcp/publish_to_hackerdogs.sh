#!/bin/bash
# Build and Publish DotDotPwn MCP Server Docker Image to Docker Hub
# Image name: dotdotpwn-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish DotDotPwn MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing DotDotPwn MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building DotDotPwn MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing DotDotPwn MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
