...
PASS=0; FAIL=0
IMAGE="hackerdogs/duckduckgo-mcp:latest"
PORT=8413
CONTAINER_NAME="duckduckgo-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"duckduckgo_info","arguments":{}}}'

echo "========== duckduckgo-mcp test (compliance) =========="
