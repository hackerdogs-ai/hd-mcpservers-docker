#!/bin/bash
# Build and Publish WhatWeb MCP Server Docker Image to Docker Hub
# Image name: whatweb-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish WhatWeb MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing WhatWeb MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building WhatWeb MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing WhatWeb MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
