#!/bin/bash
# Build and Publish Cisco AI Defense Scanner MCP Server Docker Image to Docker Hub
# Image name: cisco-mcp-scanner-mcp
...
# Configuration
IMAGE_NAME="cisco-mcp-scanner-mcp"
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Cisco AI Defense Scanner MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Cisco AI Defense Scanner MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Cisco AI Defense Scanner MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Cisco AI Defense Scanner MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
