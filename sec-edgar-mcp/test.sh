...
PASS=0; FAIL=0
IMAGE="hackerdogs/sec-edgar-mcp:latest"
PORT=8451
CONTAINER_NAME="sec-edgar-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"sec_edgar_info","arguments":{}}}'

echo "========== sec-edgar-mcp test (compliance) =========="
