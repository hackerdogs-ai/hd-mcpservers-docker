#!/bin/bash
# Build and Publish Ropper MCP Server Docker Image to Docker Hub
# Image name: ropper-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Ropper MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Ropper MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Ropper MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Ropper MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
