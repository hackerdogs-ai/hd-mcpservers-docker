#!/bin/bash
# Test script for SpiderFoot MCP Server
...
echo "================================================================================="
echo -e "${BLUE}SpiderFoot MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (run_spiderfoot)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_spiderfoot","arguments":{"arguments":"--help"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_spiderfoot returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_spiderfoot returned content"
else
    fail "tools/call run_spiderfoot did not return expected response"
