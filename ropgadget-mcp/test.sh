#!/bin/bash
# Test script for ROPgadget MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/ropgadget-mcp:latest"
PORT=8242
BINARY="ROPgadget"
CONTAINER_NAME="ropgadget-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}ROPgadget MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (run_ropgadget)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_ropgadget","arguments":{"arguments":"--help"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_ropgadget returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_ropgadget returned content"
else
    fail "tools/call run_ropgadget did not return expected response"
