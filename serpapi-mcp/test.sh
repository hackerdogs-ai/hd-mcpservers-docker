...
export MCP_FIVE_IMAGE="hackerdogs/serpapi-mcp:latest"
export MCP_FIVE_PORT=8514
export MCP_FIVE_CONTAINER="serpapi-mcp-test"
export MCP_FIVE_TITLE="SerpApi MCP — remote reference stub — 5-step compliance"
