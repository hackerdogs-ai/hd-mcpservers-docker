...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-everything-mcp:latest"
PORT=8431
CONTAINER_NAME="acuvity-mcp-server-everything-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_everything_info","arguments":{}}}'

echo "========== acuvity-mcp-server-everything-mcp test (compliance) =========="
