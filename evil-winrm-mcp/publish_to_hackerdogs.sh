#!/bin/bash
# Build and Publish Evil-WinRM MCP Server Docker Image to Docker Hub
# Image name: evil-winrm-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Evil-WinRM MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Evil-WinRM MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Evil-WinRM MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Evil-WinRM MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
