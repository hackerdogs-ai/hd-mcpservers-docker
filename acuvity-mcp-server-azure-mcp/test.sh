...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-azure-mcp:latest"
PORT=8432
CONTAINER_NAME="acuvity-mcp-server-azure-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_azure_info","arguments":{}}}'

echo "========== acuvity-mcp-server-azure-mcp test (compliance) =========="
