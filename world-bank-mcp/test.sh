...
PASS=0; FAIL=0
IMAGE="hackerdogs/world-bank-mcp:latest"
PORT=8459
CONTAINER_NAME="world-bank-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"world_bank_info","arguments":{}}}'

echo "========== world-bank-mcp test (compliance) =========="
