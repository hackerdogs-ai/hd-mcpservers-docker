#!/bin/bash
# Test script for DNSDumpster MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/dnsdumpster-mcp:latest"
PORT=8216
BINARY="dnsdumpster"
CONTAINER_NAME="dnsdumpster-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}DNSDumpster MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
# Test 6: MCP HTTP — tools/call (run_dnsdumpster --help)
info "[Test 6] MCP HTTP — tools/call (run_dnsdumpster --help)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_dnsdumpster","arguments":{"arguments":"--help"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_dnsdumpster returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_dnsdumpster returned content"
else
    fail "tools/call run_dnsdumpster did not return expected response"
