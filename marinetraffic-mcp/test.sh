...
PASS=0; FAIL=0
IMAGE="hackerdogs/marinetraffic-mcp:latest"
PORT=8430
CONTAINER_NAME="marinetraffic-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"marinetraffic_info","arguments":{}}}'

echo "========== marinetraffic-mcp test (compliance) =========="
