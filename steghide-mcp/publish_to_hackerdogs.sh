#!/bin/bash
# Build and Publish Steghide MCP Server Docker Image to Docker Hub
# Image name: steghide-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Steghide MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Steghide MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Steghide MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Steghide MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
