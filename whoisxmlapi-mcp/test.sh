...
export MCP_FIVE_IMAGE="hackerdogs/whoisxmlapi-mcp:latest"
export MCP_FIVE_PORT=8511
export MCP_FIVE_CONTAINER="whoisxmlapi-mcp-test"
export MCP_FIVE_TITLE="WhoisXML API MCP — remote reference stub — 5-step compliance"
