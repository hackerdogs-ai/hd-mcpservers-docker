...
PASS=0; FAIL=0
IMAGE="victorialogs-mcp"
PORT=8527
CONTAINER_NAME="victorialogs-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"victorialogs_query","arguments":{"query":"*","limit":1}}}'
echo "========== victorialogs-mcp test (compliance) =========="
info "[1] Install"
