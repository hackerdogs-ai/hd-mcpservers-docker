...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-grafana-mcp:latest"
PORT=8425
CONTAINER_NAME="acuvity-mcp-server-grafana-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_grafana_info","arguments":{}}}'

echo "========== acuvity-mcp-server-grafana-mcp test (compliance) =========="
