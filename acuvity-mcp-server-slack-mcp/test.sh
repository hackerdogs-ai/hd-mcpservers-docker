...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-slack-mcp:latest"
PORT=8455
CONTAINER_NAME="acuvity-mcp-server-slack-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_slack_info","arguments":{}}}'

echo "========== acuvity-mcp-server-slack-mcp test (compliance) =========="
