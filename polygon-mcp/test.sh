...
PASS=0; FAIL=0
IMAGE="hackerdogs/polygon-mcp:latest"
PORT=8445
CONTAINER_NAME="polygon-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"polygon_info","arguments":{}}}'

echo "========== polygon-mcp test (compliance) =========="
