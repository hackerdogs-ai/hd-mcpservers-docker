#!/bin/bash
# Build and Publish MCP Farm UI Docker Image to Docker Hub
# Image name: mcpfarm-ui
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish MCP Farm UI Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing MCP Farm UI Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building MCP Farm UI Docker Image${NC}"
else
    echo -e "${BLUE}Publishing MCP Farm UI Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
