...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-amass-mcp:latest"
PORT=8381
CONTAINER_NAME="acuvity-mcp-server-amass-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_amass_info","arguments":{}}}'

echo "========== acuvity-mcp-server-amass-mcp test (compliance) =========="
