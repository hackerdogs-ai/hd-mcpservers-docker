#!/bin/bash
# Build and Publish Cloud Datacenter MCP Server Docker Image to Docker Hub
# Image name: cloud-datacenter-mcp
...
# Configuration
IMAGE_NAME="cloud-datacenter-mcp"
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Cloud Datacenter MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Cloud Datacenter MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Cloud Datacenter MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Cloud Datacenter MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
