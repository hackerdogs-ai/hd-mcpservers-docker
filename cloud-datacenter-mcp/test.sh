...
PASS=0; FAIL=0
IMAGE="cloud-datacenter-mcp"
PORT=8520
CONTAINER_NAME="cloud-datacenter-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"cloud_lookup_ip","arguments":{"ip":"1.1.1.1"}}}'
echo "========== cloud-datacenter-mcp test (compliance) =========="
info "[1] Install"
