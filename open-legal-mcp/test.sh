...
PASS=0; FAIL=0
IMAGE="hackerdogs/open-legal-mcp:latest"
PORT=8439
CONTAINER_NAME="open-legal-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"open_legal_info","arguments":{}}}'

echo "========== open-legal-mcp test (compliance) =========="
