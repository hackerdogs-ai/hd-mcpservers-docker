#!/bin/bash
# Build and Publish Ghidra MCP Server Docker Image to Docker Hub
# Image name: ghidra-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Ghidra MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Ghidra MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Ghidra MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Ghidra MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
