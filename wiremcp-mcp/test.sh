...
PASS=0; FAIL=0
IMAGE="hackerdogs/wiremcp-mcp:latest"
PORT=8458
CONTAINER_NAME="wiremcp-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"wiremcp_info","arguments":{}}}'

echo "========== wiremcp-mcp test (compliance) =========="
