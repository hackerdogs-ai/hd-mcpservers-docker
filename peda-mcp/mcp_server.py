...
Wraps the gdb CLI (longld/peda) to expose
...
async def run_peda(
    ...
    logger.info("run_peda called with arguments=%s source_url=%s", arguments, source_url)
