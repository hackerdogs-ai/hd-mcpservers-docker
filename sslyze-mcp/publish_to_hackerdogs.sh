#!/bin/bash
# Build and Publish SSLyze MCP Server Docker Image to Docker Hub
# Image name: sslyze-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish SSLyze MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing SSLyze MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building SSLyze MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing SSLyze MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
