...
PASS=0; FAIL=0
IMAGE="hackerdogs/ocr-mcp:latest"
PORT=8438
CONTAINER_NAME="ocr-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"ocr_info","arguments":{}}}'

echo "========== ocr-mcp test (compliance) =========="
