...
PASS=0; FAIL=0
IMAGE="hackerdogs/rss-mcp:latest"
PORT=8448
CONTAINER_NAME="rss-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"rss_info","arguments":{}}}'

echo "========== rss-mcp test (compliance) =========="
