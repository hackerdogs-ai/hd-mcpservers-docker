...
PASS=0; FAIL=0
IMAGE="hackerdogs/shodan-mcp:latest"
PORT=8453
CONTAINER_NAME="shodan-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"shodan_info","arguments":{}}}'

echo "========== shodan-mcp test (compliance) =========="
