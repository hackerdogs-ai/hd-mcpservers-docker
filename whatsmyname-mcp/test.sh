...
PASS=0; FAIL=0
IMAGE="whatsmyname-mcp"
PORT=8528
CONTAINER_NAME="whatsmyname-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"whatsmyname_check","arguments":{"username":"test","limit":3}}}'
echo "========== whatsmyname-mcp test (compliance) =========="
info "[1] Install"
