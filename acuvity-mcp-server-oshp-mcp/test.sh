...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-oshp-mcp:latest"
PORT=8441
CONTAINER_NAME="acuvity-mcp-server-oshp-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_oshp_info","arguments":{}}}'

echo "========== acuvity-mcp-server-oshp-mcp test (compliance) =========="
