#!/bin/bash
# Build and Publish BruteSpray MCP Server Docker Image to Docker Hub
# Image name: brutespray-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish BruteSpray MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing BruteSpray MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building BruteSpray MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing BruteSpray MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
