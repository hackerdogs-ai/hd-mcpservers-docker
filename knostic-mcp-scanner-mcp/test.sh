#!/bin/bash
# Test script for Knostic Scanner MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/knostic-mcp-scanner-mcp:latest"
PORT=8344
BINARY="mcp-scanner"
CONTAINER_NAME="knostic-mcp-scanner-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Knostic Scanner MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_knostic_scanner","arguments":{"arguments":"--help"}}}'
