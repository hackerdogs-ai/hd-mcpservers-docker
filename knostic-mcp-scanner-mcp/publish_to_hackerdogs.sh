#!/bin/bash
# Build and Publish Knostic Scanner MCP Server Docker Image to Docker Hub
# Image name: knostic-mcp-scanner-mcp
...
# Configuration
IMAGE_NAME="knostic-mcp-scanner-mcp"
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Knostic Scanner MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Knostic Scanner MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Knostic Scanner MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Knostic Scanner MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
