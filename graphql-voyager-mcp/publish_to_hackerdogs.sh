#!/bin/bash
# Build and Publish GraphQL-Voyager MCP Server Docker Image to Docker Hub
# Image name: graphql-voyager-mcp
...
# Configuration
IMAGE_NAME="graphql-voyager-mcp"
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish GraphQL-Voyager MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing GraphQL-Voyager MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building GraphQL-Voyager MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing GraphQL-Voyager MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
