...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-chroma-mcp:latest"
PORT=8408
CONTAINER_NAME="acuvity-mcp-server-chroma-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_chroma_info","arguments":{}}}'

echo "========== acuvity-mcp-server-chroma-mcp test (compliance) =========="
