#!/bin/bash
# Build and Publish Pwninit MCP Server Docker Image to Docker Hub
# Image name: pwninit-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Pwninit MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Pwninit MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Pwninit MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Pwninit MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
