...
PASS=0; FAIL=0
IMAGE="hackerdogs/zscaler-mcp-server-mcp:latest"
PORT=8463
CONTAINER_NAME="zscaler-mcp-server-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"zscaler_mcp_server_info","arguments":{}}}'

echo "========== zscaler-mcp-server-mcp test (compliance) =========="
