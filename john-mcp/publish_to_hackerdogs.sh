#!/bin/bash
# Build and Publish John the Ripper MCP Server Docker Image to Docker Hub
# Image name: john-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish John the Ripper MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing John the Ripper MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building John the Ripper MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing John the Ripper MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
