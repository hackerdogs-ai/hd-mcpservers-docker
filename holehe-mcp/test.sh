#!/bin/bash
# Test script for Holehe MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/holehe-mcp:latest"
PORT=8219
BINARY="holehe"
CONTAINER_NAME="holehe-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Holehe MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (run_holehe)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_holehe","arguments":{"arguments":"--help"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_holehe returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_holehe returned content"
else
    fail "tools/call run_holehe did not return expected response"
