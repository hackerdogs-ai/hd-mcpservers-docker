...
class DbIpWeb(IGeoIpDatabase):
    ...
    def get(ip_address, api_key=None, db_path=None, username=None, password=None):
        ...
        try:
            ...
            if pyquery is None:
                raise ServiceError("Optional dependency 'pyquery' is required for DbIpWeb HTML parsing. "
                                   "Install it (e.g., `pip install pyquery`).")
...
class Ip2LocationWeb(IGeoIpDatabase):
    ...
    def get(ip_address, api_key=None, db_path=None, username=None, password=None):
        ...
        if webdriver is None or Options is None:
            raise ServiceError("Optional dependency 'selenium' is required for Ip2LocationWeb. "
                               "Install it (e.g., `pip install selenium`) and ensure a compatible browser driver.")
