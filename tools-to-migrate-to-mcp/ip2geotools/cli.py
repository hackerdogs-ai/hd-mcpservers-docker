...
from . import __author__, __author_email__, __description__, __version__
from .databases.noncommercial import DbIpCity, \
                                                HostIP, \
                                                Freegeoip, \
                                                Ipstack, \
                                                MaxMindGeoLite2City, \
                                                Ip2Location
from .databases.commercial import DbIpWeb, \
                                             MaxMindGeoIp2City, \
                                             Ip2LocationWeb, \
                                             NeustarWeb, \
                                             GeobytesCityDetails, \
...
class Command(object):
    ...
    def execute(self):
        ...
        parser = argparse.ArgumentParser(
            prog=self.prog_name,
            description='{0} version {1}'.format(self.prog_name, __version__) + \
                        '\n\n{0}'.format(__description__),
            epilog=('\n\nexample:' + \
