...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"baidu_search","arguments":{"query":"test","limit":1}}}'
echo "========== baidusearch-mcp test (compliance) =========="
info "[1] Install"
