#!/bin/bash
# Build and Publish RustScan MCP Server Docker Image to Docker Hub
# Image name: rustscan-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish RustScan MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing RustScan MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building RustScan MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing RustScan MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
