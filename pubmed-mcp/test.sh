...
PASS=0; FAIL=0
IMAGE="hackerdogs/pubmed-mcp:latest"
PORT=8446
CONTAINER_NAME="pubmed-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"pubmed_info","arguments":{}}}'

echo "========== pubmed-mcp test (compliance) =========="
