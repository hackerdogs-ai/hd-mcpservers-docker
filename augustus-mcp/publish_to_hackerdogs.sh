#!/bin/bash
# Build and Publish Augustus MCP Server Docker Image to Docker Hub
# Image name: augustus-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Augustus MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Augustus MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Augustus MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Augustus MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
