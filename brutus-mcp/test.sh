#!/bin/bash
# Test script for Brutus MCP Server
# Tests MCP protocol compliance via JSON-RPC (stdio and HTTP streamable)
# Note: tools/call skipped — credential testing requires a real target
...
PASS=0
FAIL=0
IMAGE="hackerdogs/brutus-mcp:latest"
PORT=8102
BINARY="brutus"
CONTAINER_NAME="brutus-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Brutus MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Note] Skipping tools/call — credential testing requires a real target"
echo ""
