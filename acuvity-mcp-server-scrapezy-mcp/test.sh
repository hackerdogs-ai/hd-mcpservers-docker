...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-scrapezy-mcp:latest"
PORT=8450
CONTAINER_NAME="acuvity-mcp-server-scrapezy-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_scrapezy_info","arguments":{}}}'

echo "========== acuvity-mcp-server-scrapezy-mcp test (compliance) =========="
