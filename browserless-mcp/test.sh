...
PASS=0; FAIL=0
IMAGE="hackerdogs/browserless-mcp:latest"
PORT=8518
CONTAINER_NAME="browserless-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"browserless_content","arguments":{"url":"https://example.com"}}}'
echo "========== browserless-mcp test (compliance) =========="
info "[1] Install"
