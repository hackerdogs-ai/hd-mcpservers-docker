...
PASS=0; FAIL=0
IMAGE="hackerdogs/fred-mcp:latest"
PORT=8423
CONTAINER_NAME="fred-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"fred_info","arguments":{}}}'

echo "========== fred-mcp test (compliance) =========="
