...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-calculator-mcp:latest"
PORT=8407
CONTAINER_NAME="acuvity-mcp-server-calculator-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_calculator_info","arguments":{}}}'

echo "========== acuvity-mcp-server-calculator-mcp test (compliance) =========="
