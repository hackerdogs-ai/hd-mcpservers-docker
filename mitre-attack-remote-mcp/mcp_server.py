#!/usr/bin/env python3
"""Local compliance stub for MITRE ATT&CK MCP. Production: https://attack-mcp.mitre.org/mcp"""
...
REMOTE_URL = "https://attack-mcp.mitre.org/mcp"
SERVER_KEY = "mitre-attack-remote"
...
mcp = FastMCP(
    SERVER_KEY,
    instructions=(
        "MITRE ATT&CK MCP. Use the hosted endpoint "
