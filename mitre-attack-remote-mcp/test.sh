...
export MCP_FIVE_IMAGE="hackerdogs/mitre-attack-remote-mcp:latest"
export MCP_FIVE_PORT=8516
export MCP_FIVE_CONTAINER="mitre-attack-remote-mcp-test"
export MCP_FIVE_TITLE="MITRE ATT&CK remote MCP — reference stub — 5-step compliance"
