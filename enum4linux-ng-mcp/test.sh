#!/bin/bash
# Test script for Enum4linux-ng MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/enum4linux-ng-mcp:latest"
PORT=8210
BINARY="enum4linux-ng"
CONTAINER_NAME="enum4linux-ng-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Enum4linux-ng MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (run_enum4linux_ng)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_enum4linux_ng","arguments":{"arguments":"--help"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_enum4linux_ng returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_enum4linux_ng returned content"
else
    fail "tools/call run_enum4linux_ng did not return expected response"
