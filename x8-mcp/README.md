...
MCP server wrapper for [X8](https://github.com/sh1yo/x8) — Hidden parameter discovery.

## What is X8?

X8 (x8) is a security tool that provides: **Hidden parameter discovery.**

See [sh1yo/x8](https://github.com/sh1yo/x8) for full documentation.
...
```json
{
  "mcpServers": {
    "x8-mcp": {
      "url": "http://localhost:8485/x8-mcp/mcp",
      "headers": {
...
| `MCP_PORT` | `8275` | HTTP port (only used with `streamable-http`) |
