...
PASS=0; FAIL=0
IMAGE="hackerdogs/mcp-server-code-runner-mcp:latest"
PORT=8409
CONTAINER_NAME="mcp-server-code-runner-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"mcp_server_code_runner_info","arguments":{}}}'

echo "========== mcp-server-code-runner-mcp test (compliance) =========="
