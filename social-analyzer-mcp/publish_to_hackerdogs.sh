#!/bin/bash
# Build and Publish Social-Analyzer MCP Server Docker Image to Docker Hub
# Image name: social-analyzer-mcp
...
# Configuration
IMAGE_NAME="social-analyzer-mcp"
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Social-Analyzer MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Social-Analyzer MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Social-Analyzer MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Social-Analyzer MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
