...
PASS=0; FAIL=0
IMAGE="hackerdogs/scan-url-mcp:latest"
PORT=8449
CONTAINER_NAME="scan-url-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"scan_url_info","arguments":{}}}'

echo "========== scan-url-mcp test (compliance) =========="
