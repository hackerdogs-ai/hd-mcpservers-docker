#!/usr/bin/env python3
"""Local compliance stub for Docker MCP Gateway. Production: https://mcp.docker.com/mcp"""
...
REMOTE_URL = "https://mcp.docker.com/mcp"
...
mcp = FastMCP(
    SERVER_KEY,
    instructions=(
        "Docker MCP Toolkit gateway. Use the hosted endpoint "
