...
export MCP_FIVE_IMAGE="hackerdogs/mcp-docker-mcp:latest"
export MCP_FIVE_PORT=8517
export MCP_FIVE_CONTAINER="mcp-docker-mcp-test"
export MCP_FIVE_TITLE="Docker MCP gateway — remote reference stub — 5-step compliance"
