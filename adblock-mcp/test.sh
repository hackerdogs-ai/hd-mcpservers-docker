...
IMAGE="adblock-mcp"
PORT=8508
CONTAINER_NAME="adblock-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"adblock_check_url","arguments":{"url":"https://example.com"}}}'
echo "========== adblock-mcp test (compliance) =========="
info "[1] Install"
