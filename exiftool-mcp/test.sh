...
IMAGE="exiftool-mcp"
PORT=8502
CONTAINER_NAME="exiftool-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"exiftool_extract","arguments":{"file_path":"/etc/hostname"}}}'

echo "========== exiftool-mcp test (compliance) =========="
