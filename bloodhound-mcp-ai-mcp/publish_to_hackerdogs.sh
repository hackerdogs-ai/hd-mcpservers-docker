#!/bin/bash
# Build and Publish BloodHound AI MCP Server Docker Image to Docker Hub
# Image name: bloodhound-mcp-ai-mcp
...
# Configuration
IMAGE_NAME="bloodhound-mcp-ai-mcp"
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish BloodHound AI MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing BloodHound AI MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building BloodHound AI MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing BloodHound AI MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
