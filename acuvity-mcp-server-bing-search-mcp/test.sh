...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-bing-search-mcp:latest"
PORT=8405
CONTAINER_NAME="acuvity-mcp-server-bing-search-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_bing_search_info","arguments":{}}}'

echo "========== acuvity-mcp-server-bing-search-mcp test (compliance) =========="
