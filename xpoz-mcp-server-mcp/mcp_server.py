#!/usr/bin/env python3
"""Local compliance stub for XPoz. Production: https://mcp.xpoz.io/mcp"""
...
REMOTE_URL = "https://mcp.xpoz.io/mcp"
SERVER_KEY = "xpoz-mcp-server"
...
mcp = FastMCP(
    SERVER_KEY,
    instructions=(
        "XPoz social intelligence MCP. Clients should use the hosted endpoint "
        f"{REMOTE_URL} for full tools. This image is a minimal local stub for CI (stdio + streamable HTTP)."
    ),
)
