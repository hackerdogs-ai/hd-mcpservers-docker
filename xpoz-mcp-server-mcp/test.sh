...
export MCP_FIVE_IMAGE="hackerdogs/xpoz-mcp-server-mcp:latest"
export MCP_FIVE_PORT=8510
export MCP_FIVE_CONTAINER="xpoz-mcp-server-mcp-test"
export MCP_FIVE_TITLE="XPoz MCP — remote reference stub — 5-step compliance"
