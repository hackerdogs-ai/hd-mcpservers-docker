#!/bin/bash
# Test script for Bettercap MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/bettercap-mcp:latest"
PORT=8318
BINARY="bettercap"
CONTAINER_NAME="bettercap-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Bettercap MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (run_bettercap)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_bettercap","arguments":{"arguments":"-h"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_bettercap returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_bettercap returned content"
else
    fail "tools/call run_bettercap did not return expected response"
