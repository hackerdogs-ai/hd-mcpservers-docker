#!/bin/bash
# Build and Publish MCPServer Audit MCP Server Docker Image to Docker Hub
# Image name: mcpserver-audit-mcp
...
# Configuration
IMAGE_NAME="mcpserver-audit-mcp"
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish MCPServer Audit MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing MCPServer Audit MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building MCPServer Audit MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing MCPServer Audit MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
