...
IMAGE="bitbucket-mcp"
PORT=8516
CONTAINER_NAME="bitbucket-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"bitbucket_code_search","arguments":{"query":"test","limit":5}}}'
echo "========== bitbucket-mcp test (compliance) =========="
info "[1] Install"
