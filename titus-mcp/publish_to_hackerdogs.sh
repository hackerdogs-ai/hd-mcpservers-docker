#!/bin/bash
# Build and Publish Titus MCP Server Docker Image to Docker Hub
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Titus MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
    ...
    echo "  --platforms parallel|sequential  Push both platforms at once (default) or one at a time"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Titus MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Titus MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Titus MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
