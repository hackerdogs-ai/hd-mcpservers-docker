...
MCP server wrapper for [Smbmap](https://github.com/ShaunBarton/smbmap) — SMB share enumeration and exploitation.

## What is Smbmap?

Smbmap (smbmap) is a security tool that provides: **SMB share enumeration and exploitation.**

See [ShaunBarton/smbmap](https://github.com/ShaunBarton/smbmap) for full documentation.
...
Run smbmap with the given arguments. Returns structured JSON output.
...
- "Run smbmap with --help to see all available options."
- "Use smbmap to scan the target 192.168.1.1."
- "What options does smbmap support? Show me its help output."
- "Run smbmap against example.com with default settings."
- "Execute smbmap with verbose output enabled."
- "Use the smbmap tool to analyze the target and report findings."
...
```json
{
  "mcpServers": {
    "smbmap-mcp": {
      "url": "http://localhost:8485/smbmap-mcp/mcp",
      "headers": {
