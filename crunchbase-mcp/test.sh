...
PASS=0; FAIL=0
IMAGE="hackerdogs/crunchbase-mcp:latest"
PORT=8411
CONTAINER_NAME="crunchbase-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"crunchbase_info","arguments":{}}}'

echo "========== crunchbase-mcp test (compliance) =========="
