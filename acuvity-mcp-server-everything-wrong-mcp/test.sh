...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-everything-wrong-mcp:latest"
PORT=8418
CONTAINER_NAME="acuvity-mcp-server-everything-wrong-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_everything_wrong_info","arguments":{}}}'

echo "========== acuvity-mcp-server-everything-wrong-mcp test (compliance) =========="
