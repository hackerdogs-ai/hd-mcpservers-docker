#!/bin/bash
# Test script for Feroxbuster MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/feroxbuster-mcp:latest"
PORT=8216
BINARY="feroxbuster"
CONTAINER_NAME="feroxbuster-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Feroxbuster MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
info "[Test 6] MCP HTTP — tools/call (run_feroxbuster)"
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"run_feroxbuster","arguments":{"arguments":"--help"}}}'
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_feroxbuster returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_feroxbuster returned content"
else
    fail "tools/call run_feroxbuster did not return expected response"
