#!/bin/bash
# Build and Publish BeVigil MCP Server Docker Image to Docker Hub
# Image name: bevigil-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish BeVigil MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing BeVigil MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building BeVigil MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing BeVigil MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
