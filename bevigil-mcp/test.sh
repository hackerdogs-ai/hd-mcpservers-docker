...
IMAGE="bevigil-mcp"
PORT=8515
CONTAINER_NAME="bevigil-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"bevigil_domain_osint","arguments":{"domain":"example.com"}}}'
echo "========== bevigil-mcp test (compliance) =========="
info "[1] Install"
