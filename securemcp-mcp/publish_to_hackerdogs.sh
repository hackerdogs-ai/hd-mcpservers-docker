#!/bin/bash
# Build and Publish SecureMCP MCP Server Docker Image to Docker Hub
# Image name: securemcp-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish SecureMCP MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing SecureMCP MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building SecureMCP MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing SecureMCP MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
if [ "$DO_PUBLISH" = true ]; then
