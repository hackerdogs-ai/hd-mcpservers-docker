#!/bin/bash
# Test script for Vanta MCP Server
...
PASS=0
FAIL=0
IMAGE="hackerdogs/vanta-mcp:latest"
PORT=8348
BINARY="vanta-mcp"
CONTAINER_NAME="vanta-mcp-test"
...
echo "================================================================================="
echo -e "${BLUE}Vanta MCP Server — Test Suite${NC}"
echo "================================================================================="
echo ""
...
if echo "$CALL_RESP" | grep -q '"result"'; then
    pass "tools/call run_vanta_mcp returned a result"
elif echo "$CALL_RESP" | grep -q '"content"'; then
    pass "tools/call run_vanta_mcp returned content"
else
    fail "tools/call run_vanta_mcp did not return expected response"
