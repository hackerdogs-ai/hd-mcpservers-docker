...
export MCP_FIVE_IMAGE="hackerdogs/prowler-mcp:latest"
export MCP_FIVE_PORT=8515
export MCP_FIVE_CONTAINER="prowler-mcp-test"
export MCP_FIVE_TITLE="Prowler MCP — remote reference stub — 5-step compliance"
