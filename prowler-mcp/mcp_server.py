#!/usr/bin/env python3
"""Local compliance stub for Prowler. Production: https://mcp.prowler.com/mcp"""
...
REMOTE_URL = "https://mcp.prowler.com/mcp"
SERVER_KEY = "prowler"
...
mcp = FastMCP(
    SERVER_KEY,
    instructions=(
        "Prowler cloud security MCP. Use the hosted endpoint "
