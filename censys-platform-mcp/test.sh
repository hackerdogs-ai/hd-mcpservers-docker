...
export MCP_FIVE_IMAGE="hackerdogs/censys-platform-mcp:latest"
export MCP_FIVE_PORT=8520
export MCP_FIVE_CONTAINER="censys-platform-mcp-test"
export MCP_FIVE_TITLE="Censys Platform MCP - remote reference stub - 5-step compliance"
