...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-docker-mcp:latest"
PORT=8412
CONTAINER_NAME="acuvity-mcp-server-docker-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_docker_info","arguments":{}}}'

echo "========== acuvity-mcp-server-docker-mcp test (compliance) =========="
