...
PASS=0; FAIL=0
IMAGE="hackerdogs/acuvity-mcp-server-fetch-mcp:latest"
PORT=8419
CONTAINER_NAME="acuvity-mcp-server-fetch-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"acuvity_mcp_server_fetch_info","arguments":{}}}'

echo "========== acuvity-mcp-server-fetch-mcp test (compliance) =========="
