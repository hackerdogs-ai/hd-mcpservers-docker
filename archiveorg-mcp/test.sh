...
PASS=0; FAIL=0
IMAGE="archiveorg-mcp"
PORT=8512
CONTAINER_NAME="archiveorg-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"wayback_lookup","arguments":{"url":"https://example.com"}}}'
echo "========== archiveorg-mcp test (compliance) =========="
info "[1] Install"
