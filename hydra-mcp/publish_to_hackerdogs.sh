#!/bin/bash
# Build and Publish Hydra MCP Server Docker Image to Docker Hub
# Image name: hydra-mcp
...
if [ "$SHOW_HELP" = true ]; then
    echo "Build and Publish Hydra MCP Server Docker Image to Docker Hub"
    echo ""
    echo "Usage:"
...
if [ "$DO_BUILD" = true ] && [ "$DO_PUBLISH" = true ]; then
    echo -e "${BLUE}Building and Publishing Hydra MCP Server Docker Image${NC}"
elif [ "$DO_BUILD" = true ]; then
    echo -e "${BLUE}Building Hydra MCP Server Docker Image${NC}"
else
    echo -e "${BLUE}Publishing Hydra MCP Server Docker Image to Docker Hub${NC}"
fi
echo "================================================================================="
