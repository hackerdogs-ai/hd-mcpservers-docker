...
logger = logging.getLogger("hydra-mcp")

MCP_TRANSPORT = os.environ.get("MCP_TRANSPORT", "stdio")
MCP_PORT = int(os.environ.get("MCP_PORT", "8233"))
...
def main():
    logger.info("Starting hydra-mcp server (transport=%s, port=%s)", MCP_TRANSPORT, MCP_PORT)
