...
PASS=0; FAIL=0
IMAGE="hackerdogs/bravesearch-mcp:latest"
PORT=8517
CONTAINER_NAME="bravesearch-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"brave_search","arguments":{"query":"test"}}}'
echo "========== bravesearch-mcp test (compliance) =========="
info "[1] Install"
