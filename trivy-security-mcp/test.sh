...
PASS=0; FAIL=0
IMAGE="hackerdogs/trivy-security-mcp:latest"
PORT=8456
CONTAINER_NAME="trivy-security-mcp-test"
...
CALL_REQ='{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"trivy_security_info","arguments":{}}}'

echo "========== trivy-security-mcp test (compliance) =========="
